"""
Django settings for tritonesbackend project.
...
SECRET_KEY = 'django-insecure-jm((!z8%*w&vl0%)bljg#otj6s1586d@_i62*inrul7eww)sdf'
...
WSGI_APPLICATION = 'tritonesbackend.wsgi.application'
